...
public static class Localization
{
	...
	static public bool LoadCSV (TextAsset asset) {
		return LoadCSV (asset, false);
	}

	static public bool LoadCSV (TextAsset asset, bool merge) { return LoadCSV(asset.bytes, asset, merge); }

	/// <summary>
	/// Load the specified CSV file.
	/// </summary>

	static public bool LoadCSV (byte[] bytes) {
		return LoadCSV (bytes, false);
	}

	static public bool LoadCSV (byte[] bytes, bool merge) { return LoadCSV(bytes, null, merge); }
	...
	static bool LoadCSV (byte[] bytes, TextAsset asset) {
		return LoadCSV (bytes, asset, false);
	}

	static bool LoadCSV (byte[] bytes, TextAsset asset, bool merge)
	{
