...
static public class NGUIMath
{
	...
	static public Bounds CalculateRelativeWidgetBounds (Transform relativeTo, Transform content, bool considerInactive) {
		return CalculateRelativeWidgetBounds (relativeTo, content, considerInactive, true);
	}


	static public Bounds CalculateRelativeWidgetBounds (Transform relativeTo, Transform content, bool considerInactive, bool considerParents)
	{
